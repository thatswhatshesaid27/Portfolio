                            ...
                            <ul className="space-y-6 text-3xl">
                                {
                                    LINKS.map((link)=>(
                                        ...
                                        <motion.li 
                                        variants={linkVariants}key={link.id}>
                                            <a href={`#${link.id}`}onClick={toggleMenu} className="text-5xl
                                            font-semibold uppercase tracking-wide hover:text-lime-600 lg:text-9xl">
                                                {link.name}
                                            </a>
                                        </motion.li>
                                    ))
